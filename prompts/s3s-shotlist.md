...
Invoke the **`seedance-shotlist-director`** skill from the s3s package and build the HTML shotlist directly from the user's input below. Follow the skill's SKILL.md exactly. Skip the interview — the user already has narrative content.
